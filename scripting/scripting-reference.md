...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">isParameter()</td>
...
| set\(value\) | Sets the value of this parameter | `myIntParam.set(2);` |
...
| set\(value\) | Sets the value of this parameter | `myBoolParam.set(true);` |
...
| set\(value\) | Sets the value of this parameter | `myStringParam.set("super");` |
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td style="text-align:left">set(r, g, b, [a])</td>
...
| set\(value\) | Sets the string value of the target's address. | `myTargetParam.set("/root/modules/osc");` |

#### Enum Parameter

| Method | Description | Example |
| :--- | :--- | :--- |
| addOption\(label, value\) | Add an option to the list | `myEnumParam.addOption("new option",3);` |
| get\(\) | Get the selected label | `var label = myEnumParam.get();` |
| getData\(\) | Get the selected data | `var data = myEnumParam.getData();` |
| set\(label\) | Sets the value with the provided label | `myEnumParam.set("new option");` |
...
| set\(x, y\) | Sets the value of this parameter | `myP2DParam.set(.5, 2);` |
...
| set\(x, y, z\) | Sets the value of this parameter | `myP3DParam.set(.5, 2, -1);` |

### Container

| Method | Description | Example |
| :--- | :--- | :--- |
| getChild\(childName\) | Returns the parameter or container with the provided name. | `var child = myContainer.getChild("activity");` |
| getParent\(\) | Returns the parent container | `myFloatParam.set(.5);` |
| setName\(name\) |  |  |
| setCollapsed\(value\) |  |  |
...
<table>
  ...
  <tbody>
    <tr>
      <td style="text-align:left">addTrigger(name, description)</td>
    ...
    <tr>
      <td style="text-align:left">addFloatParameter(name, description, default, min max)</td>
    ...
    <tr>
      <td style="text-align:left">addBoolParameter(name, description, default)</td>
    ...
    <tr>
      <td style="text-align:left">addStringParameter(name, description, default)</td>
    ...
    <tr>
      <td style="text-align:left">addColorParameter(name, description, default)</td>
    ...
    <tr>
      <td style="text-align:left">addPoint2DParameter(name, description)</td>
    ...
    <tr>
      <td style="text-align:left">addPoint3DParameter(name, description)</td>
    ...
    <tr>
      <td style="text-align:left">addTargetParameter(name, description)</td>
    ...
    <tr>
      <td style="text-align:left">addEnumParameter(name, description, label1, value1, label2, value2, ...)</td>
      <td
