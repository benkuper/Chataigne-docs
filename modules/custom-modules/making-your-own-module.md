...
Check out the [Data types](#data-types) section to learn more about the different data types and the options you can use for them. 
...
| `callback` | The name of the script function to call when this function is called | `"callback":"setParam"`|
| `parameters` | A collection of the command parameters. The script callback function should have as many parameters as this array. Check the [Data types](#data-types) section for more info about the possible data types | `"parameters": { "Value": { "type":"Integer" } }` |
...
| `dependency` | (Optional) (Except for `Container`) Specify an action to do based on another variable value. Check [Advanced data handling](#advanced-data-handling) for more info ||
...
>    "type":"Container",
>    "collapsed":true,
>    "First variable": { "type":"Float", "default":20, "description":"This is the first variable"},
>    "Second variable": { "type":"Float", "default":0}
>  }
...
Example: 
This example alternates between two different options based on the enum choice. 
